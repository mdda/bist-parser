...
time CUDA_VISIBLE_DEVICES=0 python src/parser.py --outdir ./output --train /media/Work_HD/yswang/dataset/glove/glove.6B/coco_train_reverse.conll --dev /media/Work_HD/yswang/dataset/glove/glove.6B/coco_dev_reverse.conll --epochs 30 --lstmdims 256 --lstmlayers 2  --k 3 --usehead --userl 
